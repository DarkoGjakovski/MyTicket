...
using MyTicket.Repository;
using MyTicket.Repository.Implementation;
using MyTicket.Repository.Interface;
using MyTicket.Services;
using MyTicket.Services.Implementation;
using MyTicket.Services.Interface;
...
namespace MyTicket.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<MyTicketApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
