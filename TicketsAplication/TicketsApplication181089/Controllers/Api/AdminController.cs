...
using TicketsApplication.Domain.Idenitity;
using TicketsApplication.Domain.Identity;
using TicketsApplication.Services.Interfaces;

namespace TicketsApplication.Controllers.Api
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public AdminController(IOrderService orderService, UserManager<TicketsApplicationUser> userManager)
        {
        ...
        [HttpGet("[action]")]
        public async Task<TicketsApplicationUser> GetUser()
        {
